...
<script>
var target_goal = "Child Education";
var goal_name = "Child Education";
var amount = 500000;
var age = 30;
var returns = 8;
var horizon = 8;
...
function checkLoginDetails()
{
	...
	$.post("/validateLogin", {mobile : ""+mobile+"", password : ""+password+""}, function(data)
    {
		...
		function(){
   			top.location = "/goal/child-education?amount="+amount+"&horizon="+horizon+"&inflation="+inflation+"&risk="+risk+"&goal_name="+goal_name;
		});
		return;
...
<div class="title-v1">
	<h1 class="goal_name text-center">Child Education Goal</h1>
</div>
</div>
</div>
...
<div class="col lamount" style="float:none;">
	...
	<input type="text" value="500000" id="txt_amount" class="fc-2" onchange="amountChange()" maxlength="9" />
	<div id="amount_slider" style="margin:0px;"></div>
</div>

<div class="col lamount" style="float:none;">
	<div><b>After years</b></div>
	<input type="text" value="8" id="txt_years" class="fc-2" onchange="yearChange()" maxlength="9" />
	<div id="year_slider" style="margin:0px;"></div>
</div>
<div class="col lamount" style="float:none;">
	<div><b>Assumed inflation</b></div>
	<input type="text" value="5" id="txt_inflation" class="fc-2" onchange="inflationChange()" maxlength="9" />
...
<button class="btn btn-primary hidden-xs" style="margin:0 auto; float: none;" onclick="checkResult()">Build My Child Education Goal</button>
</div>
</div>
...
<div class="row">
	...
	<div class="col-lg-6 col-sm-4 text-center mb-3">
		<div class="box bg-tf p-3">
			...
			<p>Future value of your Child Education<br>(adjusting for <span class="span_inflation"></span>% inflation)</p>
		</div>
	</div>
	<div class="col-lg-6 col-sm-4 text-center mb-3">
		<div class="box bg-tf p-3">
...
<div class="row"> 
<div class="col-md-12">
<h1 class="text-center">Child Education Goal</h1>
