...
function calculateEMI()
{
	...
	$.post("/tools-and-calculators/getEMICalcResult", {loan_amount : "" + principal + "",interest_rate : "" + rate + "",loan_tenure_type : "" + val + "",loan_tenure : "" + period + ""}, function(data)
   {
	...
	$('#res_emi').html(emi1.toLocaleString());
	$('#res_total_interest').html(total_interest.toLocaleString());
	$('#res_total_amount').html(total_amount.toLocaleString());
...
{	
	...
	var title = "Car Loan Calculator - "+(principal/100000)+" Lakhs loan for "+period+" yrs with "+rate+"% interest ";
	var url = "/tools-and-calculators/car-loan-emi-calculator?loan_amount="+principal+"&interest_rate="+rate+"&loan_tenure="+period+"&loan_tenure_type="+loan_tenure_type;	
	...
	for(var k=1;k<=years;k++)
	{
		...
		if(k==1)
		{
			for(var m=current_month;m<12;m++)
			{
				...
				var pr_month_str = pr_month.toLocaleString();
				var inter_month_str = inter_month.toLocaleString();
				var emi1_str = emi1.toLocaleString();
				var bal_month_str = bal_month.toLocaleString();
		...
		var pr_year1_str = pr_year1.toLocaleString();
		var inter_year_str = inter_year.toLocaleString();
		var tot_year_str = tot_year.toLocaleString();
		var bal_year_str = bal_year.toLocaleString();
           ...
           <h2 class="amfi-title bold">EMI CALCULATOR</h2>
			<div class="row margin-top14">
				 ...
				 <ul class="nav nav-tabs" role="tablist" id="myTab">
				    ...
				    <li id="li-personal" role="presentation" class="li-emi nav-item"><a class="nav-link" href="javascript:void(0)" aria-controls="tab-1" role="tab" data-toggle="tab" onclick="tabChange(2)">Personal Loan</a></li>
				    <li id="li-car" role="presentation" class="li-emi nav-item"><a class="nav-link active" href="javascript:void(0)" aria-controls="tab-1" role="tab" data-toggle="tab" onclick="tabChange(3)">Car Loan</a></li>
				  ...
				  <div class="tab-content">
				    <div role="tabpanel" class="tab-pane active" id="tab-1">
						...
						<div class="lamount">
							<div style="float:left;" id="loanamount_label"><b>Car Loan Amount (Rs)</b></div>
			   ...
			   <div class="col-md-5">
				...
				<div id="emipaymentsummary">
				  ...
				  <a href="javascript:void(0)" id="calc_btn_submit" class="btn btn-warning ladda-button mutual-funds-submit-anchor marginTop20" onclick="saveResult()" data-style="expand-right" data-size="l"><span class="ladda-label">Save Result</span></a>
			   	...
			   	<div class="row">
			   	<div class="col-md-12">  
			   		<div class="table-responsive marginTop20" id="emipaymenttable">
					</div>
			   	</div>
			   	</div>
