...
<script>
var target_goal = "Dream Home";
var goal_name = "Dream Home";
var amount = 5000000;
var age = 30;
var returns = 8;
var horizon = 15;
...
function checkLoginDetails()
{
	...
	$.post("/validateLogin", {mobile : ""+mobile+"", password : ""+password+""}, function(data)
    {
		...
		function(){
   			top.location = "/goal/dream-home?amount="+amount+"&horizon="+horizon+"&inflation="+inflation+"&risk="+risk+"&goal_name="+goal_name;
		});
		return;
...
<div class="title-v1">
	<h1 class="goal_name text-center">Dream Home Goal</h1>
</div>
</div>
</div>
...
<div class="col lamount" style="float:none;">
	...
	<input type="text" value="15" id="txt_years" class="fc-2" onchange="yearChange()" maxlength="2" />
...
<button class="btn btn-primary hidden-xs" style="margin:0 auto; float: none;" onclick="checkResult()">Build My Home Goal</button>
</div>
</div>
...
<div class="row">
	...
	<div class="col-lg-6 col-sm-4 text-center mb-3">
		<div class="box bg-tf p-3">
			...
			<p>Future value of your Dream Home<br>(adjusting for <span class="span_inflation"></span>% inflation)</p>
		</div>
	</div>
	<div class="col-lg-6 col-sm-4 text-center mb-3">
		<div class="box bg-tf p-3">
...
<div class="row"> 
<div class="col-md-12">
<h1 class="text-center">Dream Home Goal</h1>
