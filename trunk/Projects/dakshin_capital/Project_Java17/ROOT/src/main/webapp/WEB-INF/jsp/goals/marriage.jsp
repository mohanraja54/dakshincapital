...
<script>
var target_goal = "Marriage";
var goal_name = "Marriage";
var amount = 5000000;
var age = 30;
var returns = 8;
var horizon = 10;
...
function checkLoginDetails()
{
	...
	$.post("/validateLogin", {mobile : ""+mobile+"", password : ""+password+""}, function(data)
    {
		...
		function(){
   			top.location = "/goal/marriage?amount="+amount+"&horizon="+horizon+"&inflation="+inflation+"&risk="+risk+"&goal_name="+goal_name;
		});
		return;
...
<div class="title-v1">
	<h1 class="goal_name text-center">Marriage Goal</h1>
</div>
</div>
</div>
...
<div class="col lamount" style="float:none;">
	<div><b>Wedding cost is</b></div>
	<input type="text" value="5000000" id="txt_amount" class="fc-2" onchange="amountChange()" maxlength="12" />
	<div id="amount_slider" style="margin:0px;"></div>
</div>

<div class="col lamount" style="float:none;">
	<div><b>Wedding after years</b></div>
...
<button class="btn btn-primary hidden-xs" style="margin:0 auto; float: none;" onclick="checkResult()">Build My Marriage Goal</button>
</div>
</div>
...
<div class="row">
	...
	<div class="col-lg-6 col-sm-4 text-center mb-3">
		<div class="box bg-tf p-3">
			...
			<p>Future value of your Marriage<br>(adjusting for <span class="span_inflation"></span>% inflation)</p>
		</div>
	</div>
	<div class="col-lg-6 col-sm-4 text-center mb-3">
		<div class="box bg-tf p-3">
...
<div class="row"> 
<div class="col-md-12">
<h1 class="text-center">Marriage Goal</h1>
