...
public class PasswordHelper
{
	...
	public PasswordHelper( String encryptionScheme ) throws EncryptionException
	{
		this( encryptionScheme, DEFAULT_ENCRYPTION_KEY );
	}

	public static PasswordHelper getInstance() throws EncryptionException
	{
		if(INSTANCE == null)
		{
			INSTANCE = new PasswordHelper(DES_ENCRYPTION_SCHEME,DEFAULT_ENCRYPTION_KEY);
		}
		return INSTANCE;
	}

	public PasswordHelper( String encryptionScheme, String encryptionKey ) throws EncryptionException
	{
