           ...
           <div class="col-md-9 marginBottom35">
			...
			<div class="row margin-top14">
				  ...
				  <ul class="nav nav-tabs" role="tablist" id="myTab">
				    <li id="li-home" role="presentation" class="active li-emi nav-item"><a class="nav-link active" href="javascript:void(0)" aria-controls="tab-1" role="tab" data-toggle="tab" onclick="tabChange(1)">Home Loan</a></li>
				  ...
				  <div class="tab-content">
				    <div role="tabpanel" class="tab-pane active" id="tab-1">
						...
						<div class="lamount">
							<div style="float:left;" id="loanamount_label"><b>Home Loan Amount (Rs)</b></div>
			 ...
			 <!-- <div align="center">
					<a href="javascript:void(0)" id="btn_submit" class="btn btn-warning ladda-button mutual-funds-submit-anchor marginTop20" onclick="changeWealthy()" data-style="expand-right" data-size="l"><span class="ladda-label">Submit</span></a>
				</div> -->
			   </div>
