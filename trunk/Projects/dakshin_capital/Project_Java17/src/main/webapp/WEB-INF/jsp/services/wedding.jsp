      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">Children's Education and Marriage Planning </h1>
            <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Children's Education and Marriage Planning<i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="ftco-section ftco-counter mt-2">
			...
			<div class="row justify-content-center mb-5 pb-2 d-flex">
	          ...
	          <div class="col-md-6 heading-section ftco-animate pl-lg-1 pt-md-0 pt-5" style="text-align: justify;">
	          	<h2 class="mb-4">Children's Education and Marriage Planning</h2>
	            <p>
