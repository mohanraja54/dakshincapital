...
function calculateEMI()
{
	...
	$('#res_emi').html(numbersWithComma(emi1));
...
{	
	...
	var title = "Education Loan Calculator - "+(principal/100000)+" Lakhs loan for "+period+" yrs with "+rate+"% interest ";
	var url = "/tools-and-calculators/education-loan-emi-calculator?loan_amount="+principal+"&interest_rate="+rate+"&loan_tenure="+period+"&loan_tenure_type="+loan_tenure_type;	
           ...
           <h2 class="amfi-title bold">EMI CALCULATOR</h2>
			<div class="row margin-top14">
				 ...
				 <ul class="nav nav-tabs" role="tablist" id="myTab">
				    ...
				    <li id="li-education" role="presentation" class="li-emi nav-item"><a class="nav-link active" href="javascript:void(0)" aria-controls="tab-1" role="tab" data-toggle="tab" onclick="tabChange(4)">Education Loan</a></li>
				  </ul>
				  <!-- Tab panes -->
				  <div class="tab-content">
				    <div role="tabpanel" class="tab-pane active" id="tab-1">
						...
						<div class="lamount">
							<div style="float:left;" id="loanamount_label"><b>Education Loan Amount (Rs)</b></div>
