...
<script>
var target_goal = "Save Tax";
var goal_name = "Save Tax";
var amount = 60000;
var age = 30;
var returns = 8;
var horizon = 10;
...
function calculateSIPAmount()
{
	...
	sip_amount = wealth_amount / 12;
	sip_amount = Math.round(sip_amount);
	//alert("init sip_amount----->"+sip_amount);
	sip_amount = Math.ceil(sip_amount / 500) * 500;
	//alert("after sip_amount----->"+sip_amount);
	target_amount = Math.round(wealth_amount);
	...
	}else
	{
		...
		}else
		{
			...
			}else
			{
				...
				remaining_sip_amount = famt / 12;
				remaining_sip_amount = Math.ceil(remaining_sip_amount / 500) * 500;
...
function showRecommendedFunds()
{
	...
	equity_elss = parseFloat(equity_elss);
	
	var cat_rolling_array = new Array();
	cat_rolling_array.push("Equity: ELSS");
	...
	for(k=0;k<cat_rolling_array.length;k++)
    {
		...
		if(goal_based_amount <= 5000)
		{
			max_count = 1;
		}else if(goal_based_amount <= 10000)
		{
			max_count = 2;
		}else if(goal_based_amount <= 15000)
		{
			max_count = 3;
		}
...
function checkLoginDetails()
{
	...
	$.post("/validateLogin", {mobile : ""+mobile+"", password : ""+password+""}, function(data)
    {
		...
		function(){
   			top.location = "/goal/save-tax?amount="+amount+"&horizon="+horizon+"&goal_name="+goal_name;
		});
		return;
...
<div class="title-v1">
	<h1 class="goal_name text-center">Save Tax Goal</h1>
</div>
</div>
</div>
...
<div class="col lamount" style="float:none;">
	<div><b>Amount you want to save for Tax Savings (80C) Annually</b></div>
	<input type="text" value="60000" id="txt_amount" class="fc-2" onchange="amountChange()" maxlength="6" />
	<div id="amount_slider" style="margin:0px;"></div>
</div>

<div class="col lamount" style="float:none;">
	<div><b>how may years you need to save taxes</b></div>
	<input type="text" value="10" id="txt_years" class="fc-2" onchange="yearChange()" maxlength="2" />
...
<button class="btn btn-primary hidden-xs" style="margin:0 auto; float: none;" onclick="checkResult()">Build My Tax Saving Goal</button>
</div>
</div>
...
<div class="row">
	<div class="col-lg-6 col-sm-4 text-center mb-3">
		<div class="box bg-tf p-3">
			...
			<p>Your targeted Tax saving Amount annually</p>
		</div>
	</div>
	<!-- <div class="col-lg-6 col-sm-4 text-center mb-3">
		<div class="box bg-tf p-3">
			<h6><span id="span_no_years"></span></h6>
			<p>Number of years you will invest for saving taxes</p>
			<p></p>
		</div>
	</div> -->
	<div class="col-lg-6 col-sm-4 text-center mb-3">
		<div class="box bg-tf p-3">
			...
			<p>Monthly SIP Investment Required</p>
			<p></p>
		</div>
	</div>
	<div class="col-lg-6 col-sm-4 text-center mb-3">
...
<div class="row"> 
<div class="col-md-12">
<h1 class="text-center">Save Tax Goal</h1>
...
<div class="row">
	...
	<div class="col-lg-6 col-sm-4 text-center mb-3">
		<div class="box bg-tf p-3">
			...
			<p>Total Scheme Selected Value</p>
		</div>
	</div>
</div>
...
<tbody>
<tr>
<td class="border-top-0">Your targeted Tax saving Amount annually</td>
<td class="border-top-0"> <input type="text" class="fc-2 fundNamebg" value="" id="txt_goal_amount" disabled="disabled"></td>
</tr>
<tr>
<td>Number of years you will invest for saving taxes</td>
